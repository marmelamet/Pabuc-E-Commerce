...
public partial class SliderEkleme : System.Web.UI.Page
{
    ...
    "").Replace("\\", "");
                ...
                try
                {
                    ...
                    fiesta.dblayer.ExecSqlNonQuery("spInsertSlider", pars, CommandType.StoredProcedure);
                    ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "islemsonu", "alert('Slider kaydetme işlemi başarılı.');", true);
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(Page, Page.GetType(), "islemsonu", "alert('Slider kaydetme işlemi sırasında hata oluştu.');", true);
                }
            }
        }
