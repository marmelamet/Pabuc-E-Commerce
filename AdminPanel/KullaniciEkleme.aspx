<%@ Page Title="" Language="C#" MasterPageFile="AdminMaster.master" AutoEventWireup="true" CodeFile="KullaniciEkleme.aspx.cs" Inherits="KullaniciEkleme" %>
            ...
            <div class="box-content">
                <table class="control-group">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtSifre" runat="server" CssClass="input-xlarge focused" TextMode="Password"></asp:TextBox>
