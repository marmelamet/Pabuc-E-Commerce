...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            DataTable dtSlider = fiesta.dblayer.ReadSqlData("spSelectSlider2", p1, CommandType.StoredProcedure);
            ...
            DataTable dtUrunler = fiesta.dblayer.ReadSqlData("spSelectUrunler2", p2, CommandType.StoredProcedure);
    ...
    protected void rptUrunler_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        DataTable dt = fiesta.dblayer.ReadSqlData("spSelectUrunler2", p, CommandType.StoredProcedure);
        if (dt.Rows.Count > 0)
        {
