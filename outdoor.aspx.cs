...
public partial class outdoor : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            DataTable dtUrunler = fiesta.dblayer.ReadSqlData("spSelectUrunlerByOutdoorAyakkabi", p2, CommandType.StoredProcedure);
    ...
    protected void rptUrunler_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        DataTable dt = fiesta.dblayer.ReadSqlData("spSelectUrunlerByOutdoorAyakkabi", p, CommandType.StoredProcedure);
        if (dt.Rows.Count > 0)
        {
